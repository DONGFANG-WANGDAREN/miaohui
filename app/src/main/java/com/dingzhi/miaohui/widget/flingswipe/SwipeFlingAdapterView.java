package com.dingzhi.miaohui.widget.flingswipe;
...
public class SwipeFlingAdapterView extends BaseFlingAdapterView {
    ...
    private float ITEM_SMALL_WIDTH = 3;
    private float ITEM_SMALL_HIGH = 27;
     ...
     *一个快捷的方法来同时设置监听器和适配器。
     *
     * @param context  延伸onFlingListener，OnItemClickListener或两个活动背景
     * @param mAdapter 该适配器必须设置。
     */
    ...
    private void adjustChildView(View child, int index) {
        ...
        child.offsetLeftAndRight((int)(dpToPx((int)ITEM_SMALL_WIDTH)*(n-p)));
