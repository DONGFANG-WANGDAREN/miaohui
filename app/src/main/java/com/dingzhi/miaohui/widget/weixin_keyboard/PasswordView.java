 ...
 * 版权所有：SRDZ
 * 创建人：TANXIN
 * 创建日期:2016/10/13 17:55.
 * 功能描述:防微信支付键盘——弹框里面的View
...
public class PasswordView extends RelativeLayout {
    ...
    private TextView tv_title,tv_name,tv_amount,tv_fee;
    ...
    public void setAmount(String amount) {
        this.amount = amount;
        tv_amount.setVisibility(VISIBLE);
