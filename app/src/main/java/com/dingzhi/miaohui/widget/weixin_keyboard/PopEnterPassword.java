...
/**
 * 文件名：PopEnterPassword.
 * 版权所有：SRDZ
 * 创建人：TANXIN
 * 创建日期:2016/10/13 17:56.
 * 功能描述:防微信支付键盘——输入支付密码
...
public class PopEnterPassword extends PopupWindow {
    ...
    public interface Callback{
        public abstract void getpassword(String password);
    }
    ...
    public PopEnterPassword(final Activity context, String title) {
        super(context);
        this.mContext = context;
        initData();
        pwdView.setTitle(title);
    }
    public PopEnterPassword(final Activity context, String title,String name,String amount){
        super(context);
        this.mContext = context;
        initData();
        pwdView.setTitle(title);
        pwdView.setName(name);
    ...
    private void initData(){
        ...
        pwdView.setOnFinishInput(new OnPasswordInputFinish() {
            ...
            public void inputFinish(String password) {
                ...
                dismiss();
                mCallback.getpassword(password);
            }
        });
